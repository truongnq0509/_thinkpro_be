...
export async function signup(req, res, next) {
	try {
		...
		const link = `<h5>Vui lòng click vào link để xác minh tài khoản thời gian hiệu lực trong vòng 15' <a href="https://backend-thinkpro.up.railway.app/api/v1/auth/verify-email/${token}">link</a></h5>`
		await sendEmail({
